...
#define POLAR_CRANE
  ...
  #define POLAR_CENTER_OFFSET 1305.0f          // (mm)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 22.86, 495.5, 142.55, 500 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 20, 20, 25 }
...
#define MANUAL_Y_HOME_POS 0  // Set Y home to 0 since no endstop
